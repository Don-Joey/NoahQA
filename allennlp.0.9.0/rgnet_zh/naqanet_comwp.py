...
from rgnet_zh.drop_em_and_f1 import DropEmAndF1
from rgnet_zh.pointernet import Decoder
from allennlp.data.dataset import Batch
from allennlp.common.util import START_SYMBOL, END_SYMBOL

from rgnet_zh.CopyDecoder import Attention,CopyMechanism
from rgnet_zh.compute_tool import compute_gen_ans
from rgnet_zh.gnn import CharmGNN
...
class NumericallyAugmentedQaNet(Model):
    ...
    def forward(self,  # type: ignore
        ...
        bert_out,_ = self.BERT(input_ids=question_passage_tokens,attention_mask =pad_mask, token_type_ids = seqlen_ids)#, token_type_ids=seqlen_ids)
        ...
        passage_out = util.replace_masked_values(passage_out, mask_test_indices.expand(-1, -1, passage_out.size(-1)), 0.0)
