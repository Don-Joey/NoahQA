...
from rgnet_base_zh.drop_em_and_f1 import DropEmAndF1
from rgnet_base_zh.pointernet import Decoder
from allennlp.data.dataset import Batch
from allennlp.common.util import START_SYMBOL, END_SYMBOL
from rgnet_base_zh.custom_instance import SyncedFieldsInstance

from rgnet_base_zh.CopyDecoder import Attention,CopyMechanism
from rgnet_base_zh.compute_tool import compute_gen_ans
    ...
    def forward(self,  # type: ignore
        ...
        if metadata is not None:
            ...
            for i in range(batch_size):
                ...
                #print("-"*97)
                id_dict = {"question_id":metadata[i]["question_id"], "passage_id":metadata[i]["qassage_id"]}
                if answer_annotations:
                    self._drop_metrics(predicted_answer, answer_annotations,answer_history,answer_type,id_dict)
