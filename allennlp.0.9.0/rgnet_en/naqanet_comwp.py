...
from rgnet_en.drop_em_and_f1 import DropEmAndF1
from rgnet_en.pointernet import Decoder
from allennlp.data.dataset import Batch
from allennlp.common.util import START_SYMBOL, END_SYMBOL
from rgnet_en.custom_instance import SyncedFieldsInstance

from rgnet_en.CopyDecoder import Attention,CopyMechanism
from rgnet_en.compute_tool import compute_gen_ans
from rgnet_en.gnn import CharmGNN
...
class NumericallyAugmentedQaNet(Model):
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        self._bert_tokenizer = RobertaTokenizer.from_pretrained(roberta_pretrained_model)
        self.vocab_size = self._bert_tokenizer.vocab_size
        self.BERT = RobertaModel.from_pretrained(roberta_pretrained_model)
        Roberta_Config = RobertaConfig.from_pretrained(roberta_pretrained_model)
