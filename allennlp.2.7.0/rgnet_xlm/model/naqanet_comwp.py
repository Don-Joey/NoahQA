...
from rgnet_xlm.evaluate.drop_em_and_f1 import DropEmAndF1
#from naqanet_edge_gated_roberta.pointernet import Decoder
from allennlp.data import Batch
from allennlp.common.util import START_SYMBOL, END_SYMBOL
#from reedit_code.custom_instance import SyncedFieldsInstance

from rgnet_xlm.model.CopyDecoder import Attention,CopyMechanism
from rgnet_xlm.utils.compute_tool import compute_gen_ans
from rgnet_xlm.model.gnn import CharmGNN
...
class NumericallyAugmentedQaNet(Model):
    ...
    def forward(self,  # type: ignore
        ...
        bert_out = self.BERT(input_ids=question_passage_tokens,attention_mask =pad_mask).last_hidden_state
        #print("show", self.BERT(input_ids=question_passage_tokens,attention_mask =pad_mask))

        
        question_end = max(mask[:,1])
        #print("question_end", question_end)
