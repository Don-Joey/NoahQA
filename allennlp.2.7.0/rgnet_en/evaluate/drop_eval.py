...
from rgnet_en.utils.compute_tool import compute_gen_ans,split_equation_tt
from rgnet_en.utils.util import split_equation_evuation
...
def get_metrics(predicted: Union[str, List[str], Tuple[str, ...]],
    ...
    #cost, edge_em, edge_f1 = evaluate_edge(node_bag['node_dict'], node_bag['evidence_edges'], node_bag['predict_edges'],node_bag['question_id'])
