...
from rgnet.evaluate.drop_eval import (get_metrics as drop_em_and_f1,
...
class DropEmAndF1(Metric):
    ...
    def __call__(self, prediction: Union[str, List], ground_truths: List, history_answer: Dict,answer_type: List, node_bag: Dict):  # type: ignore
        ...
        exact_match, f1_score, supporting_exact, supporting_count, type_EM, type_f1, type_count,edge_em ,total_em = self.metric_max_over_ground_truths(
            drop_em_and_f1,
            prediction,
        ...
        self._arithmetic_f1 += 0.0
        self._arithmetic_open_f1 += 0.0
        self._edge_em += edge_em
        self._total_edge += total_em
    ...
    def get_metric(self, reset: bool = False) -> Tuple[
        ...
        edge_em = self._edge_em/self._total_edge
        ...
        return exact_match, f1_score, supporting_ratio, supporting_right, judge_em, \
               ...
               judge_f1, comp_f1, open_f1, unsure_f1, extract_f1, arithmetic_f1, arithmetic_open_f1, edge_em
